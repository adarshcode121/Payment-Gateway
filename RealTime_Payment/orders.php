...
.popup-container {
    ...
    background: white;
    border-radius: 10px;
    box-shadow: 0px 5px 20px rgba(0, 0, 0, 0.4); /* Stronger shadow */
    overflow: hidden;
    width: 70%;
    max-width: 900px;
    z-index: 1; /* Ensures it's above the dimmed background */
...
/* Optional: Change the popup arrow color */
/* .leaflet-popup-tip {
...
<body>
    ...
    <script>
        ...
        let marker = L.marker([20.2765, 73.0202], { draggable: true }).addTo(map);
      
        const locations = {
    "Silvassa": [
        { name: "Main Road", lat: 20.2765, lng: 73.0202 },
        { name: "Dadra Road", lat: 20.2745, lng: 73.0250 },
        { name: "Vasona", lat: 20.2690, lng: 73.0335 },
        { name: "Silvassa - Daman Road", lat: 20.2830, lng: 73.0125 },
        { name: "Khanvel", lat: 20.2080, lng: 73.0500 }
    ],
    "Vapi": [
        { name: "GIDC Vapi", lat: 20.3662, lng: 72.9226 },
        { name: "Chala", lat: 20.3800, lng: 72.9100 },
        { name: "Gunjan", lat: 20.3720, lng: 72.9215 },
        { name: "Daman Check Post", lat: 20.3902, lng: 72.9108 },
        { name: "Balitha", lat: 20.3705, lng: 72.9302 }
    ],
    "Daman": [
        { name: "Moti Daman", lat: 20.3974, lng: 72.8328 },
        { name: "Nani Daman", lat: 20.4170, lng: 72.8310 },
        { name: "Devka Beach Road", lat: 20.4285, lng: 72.8220 },
        { name: "Coast Guard Colony", lat: 20.4150, lng: 72.8355 },
        { name: "Mashal Chowk", lat: 20.4200, lng: 72.8280 }
    ],
    "Valsad": [
        { name: "Tithal Road", lat: 20.6107, lng: 72.9258 },
        { name: "Dharampur Road", lat: 20.6000, lng: 72.9150 },
        { name: "Halar", lat: 20.6200, lng: 72.9350 },
        { name: "Parnera", lat: 20.6305, lng: 72.9405 },
        { name: "Abrama", lat: 20.6155, lng: 72.9200 }
    ]
};
        ...
        //         map.setView([street.lat, street.lng], 14);
        //     }
        // }
...
//         // ✅ Move map smoothly to the marker's location
//         map.panTo([street.lat, street.lng]);

//         // ✅ Add popup with notification
//         marker.bindPopup("<b>Your order will be delivered here!</b>").openPopup();

//         // ✅ Delay map adjustment to ensure popup visibility
//         setTimeout(() => {
//             map.setView([street.lat, street.lng], 15);
//         }, 500);
//     }
// }
...
function updateMap() {
    ...
    if (streetData) {
        ...
        map.flyTo([street.lat, street.lng], 14, {
